...
<html lang="ja">
  ...
  <input name="birthday" type="date" value="<?php if(!empty($_SESSION["birthday"])){echo $_SESSION["birthday"];}?>" />
    ...
    <br><br>
      自宅住所<br>
    <input type="text" placeholder="郵便番号" name="postcode" oninput="fetchAddress(this.value)" value ="<?php if(!empty($_SESSION["postcode"])){echo $_SESSION["postcode"];}?>">
    ...
    <input type="text" placeholder="市区町村" id="city" name="city" value ="<?php if(!empty($_SESSION["city"])){echo $_SESSION["city"];}?>">
